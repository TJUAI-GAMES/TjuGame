...
2.纳什均衡： 符合纳什均衡的游戏更有可玩性  可用于进行游戏规则可玩性的判定

呼延旭东
3.17
阅读《MATLAB与机器学习》
机器学习所有学习方法都是由数据驱动，而数据由人驱动。
学习机：机器获取来自环境的信息并对环境进行适应。输入可分为立即响应的输入以及用于学习的输入。

3.29
牟婧妍
阅读论文主要内容：
1.在线扑克玩家：主要讲德州扑克的策略，纳什均衡，统计利润
2.暗物质模型：与扑克游戏无关
3.麻将非玩家角色权重向量的演化：主要讲述麻将、扑克游戏中的不完美信息
